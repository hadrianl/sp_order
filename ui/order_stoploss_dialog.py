...
class Ui_Dialog_order_stoploss(object):
    def setupUi(self, Dialog_order_stoploss):
        ...
        Dialog_order_stoploss.resize(539, 304)
        self.horizontalLayout_31 = QtWidgets.QHBoxLayout(Dialog_order_stoploss)
        ...
        self.tableWidget_bid_ask = QtWidgets.QTableWidget(self.tab)
        ...
        self.tableWidget_bid_ask.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(7)
        ...
        self.tableWidget_bid_ask.horizontalHeader().setDefaultSectionSize(50)
        ...
        self.tableWidget_bid_ask.verticalHeader().setDefaultSectionSize(21)
        self.tableWidget_bid_ask.verticalHeader().setMinimumSectionSize(10)
        self.gridLayout.addWidget(self.tableWidget_bid_ask, 0, 3, 1, 1)
