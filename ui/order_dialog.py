...
class Ui_Dialog_order(object):
    def setupUi(self, Dialog_order):
        ...
        self.checkBox_remain_conf = QtWidgets.QCheckBox(Dialog_order)
        ...
        Dialog_order.setTabOrder(self.checkBox_OrderOptions, self.checkBox_remain_conf)
        Dialog_order.setTabOrder(self.checkBox_remain_conf, self.checkBox_invalid)
    ...
    def retranslateUi(self, Dialog_order):
        ...
        self.checkBox_remain_conf.setText(_translate("Dialog_order", "保持设定"))
