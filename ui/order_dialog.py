...
class Ui_Dialog_order(object):
    def setupUi(self, Dialog_order):
        ...
        Dialog_order.setEnabled(True)
        Dialog_order.resize(387, 262)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(Dialog_order)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_Ref = QtWidgets.QLabel(Dialog_order)
        ...
        self.lineEdit_Ref = QtWidgets.QLineEdit(Dialog_order)
        ...
        self.label_CondType = QtWidgets.QLabel(Dialog_order)
        ...
        self.comboBox_CondType = QtWidgets.QComboBox(Dialog_order)
        ...
        self.stackedWidget = QtWidgets.QStackedWidget(Dialog_order)
        ...
        self.comboBox_account = QtWidgets.QComboBox(Dialog_order)
        ...
        self.checkBox_lock = QtWidgets.QCheckBox(Dialog_order)
        ...
        self.label_Price = QtWidgets.QLabel(Dialog_order)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBox_Price = QtWidgets.QSpinBox(Dialog_order)
        ...
        self.checkBox_Auction = QtWidgets.QCheckBox(Dialog_order)
        ...
        self.checkBox_Market = QtWidgets.QCheckBox(Dialog_order)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_Qty = QtWidgets.QLabel(Dialog_order)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBox_Qty = QtWidgets.QSpinBox(Dialog_order)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_buy = QtWidgets.QPushButton(Dialog_order)
        ...
        self.pushButton_sell = QtWidgets.QPushButton(Dialog_order)
        ...
        Dialog_order.setTabOrder(self.lineEdit_ProdCode, self.checkBox_lock)
        Dialog_order.setTabOrder(self.checkBox_lock, self.spinBox_Price)
        Dialog_order.setTabOrder(self.spinBox_Price, self.spinBox_Qty)
        Dialog_order.setTabOrder(self.spinBox_Qty, self.pushButton_buy)
        Dialog_order.setTabOrder(self.pushButton_buy, self.pushButton_sell)
        Dialog_order.setTabOrder(self.pushButton_sell, self.comboBox_CondType)
        Dialog_order.setTabOrder(self.comboBox_CondType, self.comboBox_ValidType)
        Dialog_order.setTabOrder(self.comboBox_ValidType, self.dateEdit_ValidTime)
        Dialog_order.setTabOrder(self.dateEdit_ValidTime, self.checkBox_stop_tri)
        Dialog_order.setTabOrder(self.checkBox_stop_tri, self.spinBox_StopLevel)
        Dialog_order.setTabOrder(self.spinBox_StopLevel, self.lineEdit_Ref)
        Dialog_order.setTabOrder(self.lineEdit_Ref, self.checkBox_OrderOptions)
        Dialog_order.setTabOrder(self.checkBox_OrderOptions, self.checkBox_invalid)
        Dialog_order.setTabOrder(self.checkBox_invalid, self.checkBox_Auction)
        Dialog_order.setTabOrder(self.checkBox_Auction, self.checkBox_Market)
        Dialog_order.setTabOrder(self.checkBox_Market, self.radioButton_sell2)
        Dialog_order.setTabOrder(self.radioButton_sell2, self.spinBox_oco_StopLevel)
        Dialog_order.setTabOrder(self.spinBox_oco_StopLevel, self.spinBox_oco_toler)
        Dialog_order.setTabOrder(self.spinBox_oco_toler, self.spinBox_market_level)
        Dialog_order.setTabOrder(self.spinBox_market_level, self.spinBox_bullbear_profit)
        Dialog_order.setTabOrder(self.spinBox_bullbear_profit, self.spinBox_bullbear_loss)
        Dialog_order.setTabOrder(self.spinBox_bullbear_loss, self.spinBox_bullbear_loss_toler)
        Dialog_order.setTabOrder(self.spinBox_bullbear_loss_toler, self.dateTimeEdit_sched_time)
        Dialog_order.setTabOrder(self.dateTimeEdit_sched_time, self.comboBox_account)
        Dialog_order.setTabOrder(self.comboBox_account, self.radioButton_sell1)
        Dialog_order.setTabOrder(self.radioButton_sell1, self.spinBox_StopLevel2)
        Dialog_order.setTabOrder(self.spinBox_StopLevel2, self.spinBox_toler)
        Dialog_order.setTabOrder(self.spinBox_toler, self.spinBox_trailing_stop_step)
        Dialog_order.setTabOrder(self.spinBox_trailing_stop_step, self.radioButton_buy2)
        Dialog_order.setTabOrder(self.radioButton_buy2, self.checkBox_Trailing_Stop)
        Dialog_order.setTabOrder(self.checkBox_Trailing_Stop, self.comboBox_StopType)
        Dialog_order.setTabOrder(self.comboBox_StopType, self.radioButton_buy1)

    def retranslateUi(self, Dialog_order):
        _translate = QtCore.QCoreApplication.translate
        Dialog_order.setWindowTitle(_translate("Dialog_order", "SP  ORDER"))
        self.label_Ref.setText(_translate("Dialog_order", "参考"))
        self.checkBox_OrderOptions.setText(_translate("Dialog_order", "T+1"))
        self.checkBox_invalid.setText(_translate("Dialog_order", "无效"))
        self.checkBox_order_assistant.setText(_translate("Dialog_order", "下单辅助"))
        self.label_CondType.setText(_translate("Dialog_order", "条件"))
        self.comboBox_CondType.setItemText(0, _translate("Dialog_order", "普通指令"))
        self.comboBox_CondType.setItemText(1, _translate("Dialog_order", "止损指令"))
        self.comboBox_CondType.setItemText(2, _translate("Dialog_order", "双向限价"))
        self.comboBox_CondType.setItemText(3, _translate("Dialog_order", "牛市熊市"))
        self.comboBox_CondType.setItemText(4, _translate("Dialog_order", "预订指令"))
        self.groupBox.setTitle(_translate("Dialog_order", "有效期"))
        self.label_ValidType.setText(_translate("Dialog_order", "类型"))
        self.comboBox_ValidType.setItemText(0, _translate("Dialog_order", "即日"))
        self.comboBox_ValidType.setItemText(1, _translate("Dialog_order", "成交并取消"))
        self.comboBox_ValidType.setItemText(2, _translate("Dialog_order", "成交或取消"))
        self.comboBox_ValidType.setItemText(3, _translate("Dialog_order", "到期日"))
        self.comboBox_ValidType.setItemText(4, _translate("Dialog_order", "指定日期"))
        self.label_ValidTime.setText(_translate("Dialog_order", "日期"))
        self.dateEdit_ValidTime.setDisplayFormat(_translate("Dialog_order", "yyyy/M/d"))
        self.checkBox_stop_tri.setText(_translate("Dialog_order", " 止损/触发"))
        self.comboBox_StopType.setItemText(0, _translate("Dialog_order", "限止"))
        self.comboBox_StopType.setItemText(1, _translate("Dialog_order", "升市"))
        self.comboBox_StopType.setItemText(2, _translate("Dialog_order", "跌市"))
        self.comboBox_StopType.setItemText(3, _translate("Dialog_order", "市止"))
        self.radioButton_buy1.setText(_translate("Dialog_order", "买入"))
        self.radioButton_sell1.setText(_translate("Dialog_order", "沽出"))
        self.label_9.setText(_translate("Dialog_order", "止损价"))
        self.label_10.setText(_translate("Dialog_order", "追价"))
        self.checkBox_Trailing_Stop.setText(_translate("Dialog_order", "追踪止损"))
        self.label_11.setText(_translate("Dialog_order", "梯级"))
        self.radioButton_buy2.setText(_translate("Dialog_order", "买入"))
        self.radioButton_sell2.setText(_translate("Dialog_order", "沽出"))
        self.label_12.setText(_translate("Dialog_order", "限价止损"))
        self.label_13.setText(_translate("Dialog_order", "追价"))
        self.label_2.setText(_translate("Dialog_order", "市价追价"))
        self.label_14.setText(_translate("Dialog_order", "止赚"))
        self.label_15.setText(_translate("Dialog_order", "止损"))
        self.label_16.setText(_translate("Dialog_order", "止损追价"))
        self.dateTimeEdit_sched_time.setDisplayFormat(_translate("Dialog_order", "M/d dddd H:mm"))
        self.label.setText(_translate("Dialog_order", "账户"))
        self.label__ProdCode.setText(_translate("Dialog_order", "代码"))
        self.checkBox_lock.setText(_translate("Dialog_order", "锁定"))
        self.label_Price.setText(_translate("Dialog_order", "价格"))
        self.checkBox_Auction.setText(_translate("Dialog_order", "竞价"))
        self.checkBox_Market.setText(_translate("Dialog_order", "市价"))
        self.label_Qty.setText(_translate("Dialog_order", "数量"))
        self.pushButton_buy.setText(_translate("Dialog_order", "买入"))
        self.pushButton_sell.setText(_translate("Dialog_order", "沽出"))
