...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_lock = QtWidgets.QCheckBox(Dialog)
        ...
        Dialog.setTabOrder(self.lineEdit_ProdCode, self.checkBox_lock)
        Dialog.setTabOrder(self.checkBox_lock, self.spinBox_Price)
        Dialog.setTabOrder(self.spinBox_Price, self.spinBox_Qty)
        Dialog.setTabOrder(self.spinBox_Qty, self.pushButton_buy)
        Dialog.setTabOrder(self.pushButton_buy, self.pushButton_sell)
        Dialog.setTabOrder(self.pushButton_sell, self.comboBox_CondType)
        Dialog.setTabOrder(self.comboBox_CondType, self.comboBox_ValidType)
        Dialog.setTabOrder(self.comboBox_ValidType, self.dateEdit_ValidTime)
        Dialog.setTabOrder(self.dateEdit_ValidTime, self.checkBox_stop_tri)
        Dialog.setTabOrder(self.checkBox_stop_tri, self.spinBox_StopLevel)
        Dialog.setTabOrder(self.spinBox_StopLevel, self.lineEdit_Ref)
        Dialog.setTabOrder(self.lineEdit_Ref, self.checkBox_OrderOptions)
        Dialog.setTabOrder(self.checkBox_OrderOptions, self.checkBox_remain_conf)
        Dialog.setTabOrder(self.checkBox_remain_conf, self.checkBox_invalid)
        Dialog.setTabOrder(self.checkBox_invalid, self.checkBox_Auction)
        Dialog.setTabOrder(self.checkBox_Auction, self.checkBox_Market)
        Dialog.setTabOrder(self.checkBox_Market, self.radioButton_sell2)
        Dialog.setTabOrder(self.radioButton_sell2, self.spinBox_oco_StopLevel)
        Dialog.setTabOrder(self.spinBox_oco_StopLevel, self.spinBox_oco_toler)
        Dialog.setTabOrder(self.spinBox_oco_toler, self.spinBox_market_level)
        Dialog.setTabOrder(self.spinBox_market_level, self.spinBox_bullbear_profit)
        Dialog.setTabOrder(self.spinBox_bullbear_profit, self.spinBox_bullbear_loss)
        Dialog.setTabOrder(self.spinBox_bullbear_loss, self.spinBox_bullbear_loss_toler)
        Dialog.setTabOrder(self.spinBox_bullbear_loss_toler, self.dateTimeEdit_sched_time)
        Dialog.setTabOrder(self.dateTimeEdit_sched_time, self.comboBox_account)
        Dialog.setTabOrder(self.comboBox_account, self.radioButton_sell1)
        Dialog.setTabOrder(self.radioButton_sell1, self.spinBox_StopLevel2)
        Dialog.setTabOrder(self.spinBox_StopLevel2, self.spinBox_toler)
        Dialog.setTabOrder(self.spinBox_toler, self.spinBox_trailing_stop_step)
        Dialog.setTabOrder(self.spinBox_trailing_stop_step, self.radioButton_buy2)
        Dialog.setTabOrder(self.radioButton_buy2, self.checkBox_Trailing_Stop)
        Dialog.setTabOrder(self.checkBox_Trailing_Stop, self.comboBox_StopType)
        Dialog.setTabOrder(self.comboBox_StopType, self.radioButton_buy1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_lock.setText(_translate("Dialog", "锁定"))
