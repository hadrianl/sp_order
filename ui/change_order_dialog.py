...
# Form implementation generated from reading ui file 'change_order_dialog.ui'
#
...
class Ui_Dialog_change_order(object):
    ...
    def retranslateUi(self, Dialog_change_order):
        _translate = QtCore.QCoreApplication.translate
        Dialog_change_order.setWindowTitle(_translate("Dialog_change_order", "SP CHANGE ORDER"))
        self.label_Ref.setText(_translate("Dialog_change_order", "参考"))
        self.checkBox_OrderOptions.setText(_translate("Dialog_change_order", "T+1"))
        self.label_CondType.setText(_translate("Dialog_change_order", "条件"))
        self.comboBox_CondType.setItemText(0, _translate("Dialog_change_order", "普通指令"))
        self.comboBox_CondType.setItemText(1, _translate("Dialog_change_order", "止损指令"))
        self.comboBox_CondType.setItemText(2, _translate("Dialog_change_order", "双向限价"))
        self.comboBox_CondType.setItemText(3, _translate("Dialog_change_order", "牛市熊市"))
        self.comboBox_CondType.setItemText(4, _translate("Dialog_change_order", "预订指令"))
        self.groupBox.setTitle(_translate("Dialog_change_order", "有效期"))
        self.label_ValidType.setText(_translate("Dialog_change_order", "类型"))
        self.comboBox_ValidType.setItemText(0, _translate("Dialog_change_order", "即日"))
        self.comboBox_ValidType.setItemText(1, _translate("Dialog_change_order", "成交并取消"))
        self.comboBox_ValidType.setItemText(2, _translate("Dialog_change_order", "成交或取消"))
        self.comboBox_ValidType.setItemText(3, _translate("Dialog_change_order", "到期日"))
        self.comboBox_ValidType.setItemText(4, _translate("Dialog_change_order", "指定日期"))
        self.label_ValidTime.setText(_translate("Dialog_change_order", "日期"))
        self.dateEdit_ValidTime.setDisplayFormat(_translate("Dialog_change_order", "yyyy/M/d"))
        self.checkBox_stop_tri.setText(_translate("Dialog_change_order", " 止损/触发"))
        self.comboBox_StopType.setItemText(0, _translate("Dialog_change_order", "限止"))
        self.comboBox_StopType.setItemText(1, _translate("Dialog_change_order", "升市"))
        self.comboBox_StopType.setItemText(2, _translate("Dialog_change_order", "跌市"))
        self.comboBox_StopType.setItemText(3, _translate("Dialog_change_order", "市止"))
        self.radioButton_buy1.setText(_translate("Dialog_change_order", "买入"))
        self.radioButton_sell1.setText(_translate("Dialog_change_order", "沽出"))
        self.label_9.setText(_translate("Dialog_change_order", "止损价"))
        self.label_10.setText(_translate("Dialog_change_order", "追价"))
        self.checkBox_Trailing_Stop.setText(_translate("Dialog_change_order", "追踪止损"))
        self.label_11.setText(_translate("Dialog_change_order", "梯级"))
        self.radioButton_buy2.setText(_translate("Dialog_change_order", "买入"))
        self.radioButton_sell2.setText(_translate("Dialog_change_order", "沽出"))
        self.label_12.setText(_translate("Dialog_change_order", "限价止损"))
        self.label_13.setText(_translate("Dialog_change_order", "追价"))
        self.label_2.setText(_translate("Dialog_change_order", "市价追价"))
        self.label_14.setText(_translate("Dialog_change_order", "止赚"))
        self.label_15.setText(_translate("Dialog_change_order", "止损"))
        self.label_16.setText(_translate("Dialog_change_order", "止损追价"))
        self.dateTimeEdit_sched_time.setDisplayFormat(_translate("Dialog_change_order", "M/d dddd H:mm"))
        self.label__ProdCode.setText(_translate("Dialog_change_order", "代码:"))
        self.label_Price.setText(_translate("Dialog_change_order", "价格"))
        self.label_Qty.setText(_translate("Dialog_change_order", "数量"))
        self.pushButton_buy.setText(_translate("Dialog_change_order", "更改买入"))
        self.pushButton_sell.setText(_translate("Dialog_change_order", "更改沽出"))
