...
class Ui_Form_acc_info(object):
    def setupUi(self, Form_acc_info):
        ...
        self.pushButton_Order.setCheckable(True)
        ...
        self.pushButton_QuickStoploss = QtWidgets.QPushButton(Form_acc_info)
        self.pushButton_QuickStoploss.setObjectName("pushButton_QuickStoploss")
        self.horizontalLayout.addWidget(self.pushButton_QuickStoploss)
    ...
    def retranslateUi(self, Form_acc_info):
        ...
        self.pushButton_QuickStoploss.setText(_translate("Form_acc_info", "快速止损"))
