...
class Ui_Form_acc_info(object):
    def setupUi(self, Form_acc_info):
        ...
        self.pushButton_trade_history = QtWidgets.QPushButton(Form_acc_info)
        self.pushButton_trade_history.setObjectName("pushButton_trade_history")
        self.horizontalLayout.addWidget(self.pushButton_trade_history)
    ...
    def retranslateUi(self, Form_acc_info):
        ...
        self.pushButton_trade_history.setText(_translate("Form_acc_info", "交易记录"))
